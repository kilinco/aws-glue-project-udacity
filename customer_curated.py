...
DropFields_node1766967915777 = DropFields.apply(frame=DropDuplicates_node1766967306781, paths=["user", "timestamp", "x", "y", "z"], transformation_ctx="DropFields_node1766967915777")

# Script generated for node Customer Curated
EvaluateDataQuality().process_rows(frame=DropFields_node1766967915777, ruleset=DEFAULT_DATA_QUALITY_RULESET, publishing_options={"dataQualityEvaluationContext": "EvaluateDataQuality_node1766958210074", "enableDataQualityResultsPublishing": True}, additional_options={"dataQualityResultsPublishing.strategy": "BEST_EFFORT", "observations.scope": "ALL"})
CustomerCurated_node1766958674630 = glueContext.getSink(path="s3://spark-877687662547-bucket/customer/curated/", connection_type="s3", updateBehavior="UPDATE_IN_DATABASE", partitionKeys=[], enableUpdateCatalog=True, transformation_ctx="CustomerCurated_node1766958674630")
CustomerCurated_node1766958674630.setCatalogInfo(catalogDatabase="lakehouse_db",catalogTableName="customer_curated")
CustomerCurated_node1766958674630.setFormat("json")
CustomerCurated_node1766958674630.writeFrame(DropFields_node1766967915777)
job.commit()